...
export class AnalysisService {
    ...
    return {
      data: {
        ...
        offlineData: [
          ...
          { name: 'Stores 2', cvr: 0.3 },
          { name: 'Stores 3', cvr: 0.4 },
          { name: 'Stores 4', cvr: 0.2 },
          { name: 'Stores 5', cvr: 0.8 },
          { name: 'Stores 6', cvr: 0.3 },
          { name: 'Stores 7', cvr: 0.8 },
          { name: 'Stores 8', cvr: 0.7 },
          { name: 'Stores 9', cvr: 0.6 },
        ],
        offlineChartData: this.generateWorkplaceOfflineChartData(),
        salesTypeData: [
          { x: '家用电器', y: 4544 },
          { x: '食用酒水', y: 3321 },
          { x: '个护健康', y: 3113 },
  ...
  private generateWorkplaceOfflineChartData(): WorkplaceOfflineChartDataDto[] {
    const data: WorkplaceOfflineChartDataDto[] = [];
    const startTime = Date.now();
    for (let i = 0; i < 20; i++) {
      data.push({
        x: startTime + i * 1800000, // 每半小时一条
